...
const WHEEL_LENGTH_M = 0.03; // How long the wheel is along the robot's direction of travel (e.g., contact patch)
const WHEEL_WIDTH_M = 0.015;  // How thick the wheel is (its actual width)
